...
<center>
  <center><button id="myBtn1">REMOVE SUBJECT</button>
  <button id="myBtn">ADD SUBJECT</button></center>
 <br>
   ...
   <div class="modal-content">
      ...
      <?php
        ...
        if(mysqli_num_rows($result) > 0 ){
          while ($row = mysqli_fetch_array ($result)) {
        ?>
          <a href="delete.php?subject=<?php echo $row['subject'];?>"><button id ="myBtn2"> <?php echo $row['subject'];?></button></a>
        <?php
          }
        }
        ?>
...
<center><div id="myModal" class="modal">
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <center>
        <form method="post" action ="list_subj_admin.php">   
        <br>
